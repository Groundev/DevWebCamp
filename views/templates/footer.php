<footer class="footer">
    <div class="footer__grid">
        <div class="footer__contenido">
            ...
            <p class="footer__texto">DevWebCamp es una conferencia para los desarrolladores de cualquier nivel,
                se lleva a cabo de forma presencial y en línea </p>
        </div>
    ...
    <p class="footer__copyright">DevWebCamp &copy;
        <span class="footer__copyright--regular">
            - Todos los derechos están reservados <?php echo date('Y');?>
        </span>
    </p>
</footer>